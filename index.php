            ...
            <div id="menuItem1">
                ...
                <br>
                    <span class="subtitle">
                        ...
                        echo("test");
                        $request_token = $connection->oauth('oauth/request_token', array('oauth_callback' => 'https://trendingwhere.azurewebsites.net/twitterproxy/1.1/account/verify_credentials.php?skip_status=1&callback=jsfunc'));
