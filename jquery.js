...
function initialize() {
    ...
    google.maps.event.addListener(marker1, 'click', function () {
        var obj = $.getJSON('/twitter-proxy.php?url=' + encodeURIComponent('trends/place.json?id=21125'), function (result) {
            ...
            trend[0].innerHTML= '<a href="' + obj.responseJSON[0].trends[0].url + '" target="_blank">' + obj.responseJSON[0].trends[0].name + '</a><br>' + ((obj.responseJSON[0].trends[0].tweet_volume != null) ? obj.responseJSON[0].trends[0].tweet_volume + " tweets" : '<br>');
