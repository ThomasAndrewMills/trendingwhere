...
function initialize() {
    ...
    google.maps.event.addListener(marker1, 'click', function () {
        var obj = $.getJSON('/twitter-proxy.php?url=' + encodeURIComponent('trends/place.json?id=21125'), function (result) {
            ...
            trend[0].innerHTML= '<a href="' + obj.responseJSON[0].trends[3].url + '" target="_blank">' + obj.responseJSON[0].trends[3].name + '</a><br><span class="tweetVolume">' + ((obj.responseJSON[0].trends[3].tweet_volume != null) ? obj.responseJSON[0].trends[3].tweet_volume + " tweets" + '</span>' : '</span><br>');
            trend[1].innerHTML= '<a href="' + obj.responseJSON[0].trends[3].url + '" target="_blank">' + obj.responseJSON[0].trends[3].name + '</a><br><span class="tweetVolume">' + ((obj.responseJSON[0].trends[3].tweet_volume != null) ? obj.responseJSON[0].trends[3].tweet_volume + " tweets" + '</span>' : '</span><br>');
            trend[2].innerHTML= '<a href="' + obj.responseJSON[0].trends[3].url + '" target="_blank">' + obj.responseJSON[0].trends[3].name + '</a><br><span class="tweetVolume">' + ((obj.responseJSON[0].trends[3].tweet_volume != null) ? obj.responseJSON[0].trends[3].tweet_volume + " tweets" + '</span>' : '</span><br>');
            ...
            trend[4].innerHTML= '<a href="' + obj.responseJSON[0].trends[3].url + '" target="_blank">' + obj.responseJSON[0].trends[3].name + '</a><br><span class="tweetVolume">' + ((obj.responseJSON[0].trends[3].tweet_volume != null) ? obj.responseJSON[0].trends[3].tweet_volume + " tweets" + '</span>' : '</span><br>');
            trend[5].innerHTML= '<a href="' + obj.responseJSON[0].trends[3].url + '" target="_blank">' + obj.responseJSON[0].trends[3].name + '</a><br><span class="tweetVolume">' + ((obj.responseJSON[0].trends[3].tweet_volume != null) ? obj.responseJSON[0].trends[3].tweet_volume + " tweets" + '</span>' : '</span><br>');
            trend[6].innerHTML= '<a href="' + obj.responseJSON[0].trends[3].url + '" target="_blank">' + obj.responseJSON[0].trends[3].name + '</a><br><span class="tweetVolume">' + ((obj.responseJSON[0].trends[3].tweet_volume != null) ? obj.responseJSON[0].trends[3].tweet_volume + " tweets" + '</span>' : '</span><br>');
            trend[7].innerHTML= '<a href="' + obj.responseJSON[0].trends[3].url + '" target="_blank">' + obj.responseJSON[0].trends[3].name + '</a><br><span class="tweetVolume">' + ((obj.responseJSON[0].trends[3].tweet_volume != null) ? obj.responseJSON[0].trends[3].tweet_volume + " tweets" + '</span>' : '</span><br>');
            trend[8].innerHTML= '<a href="' + obj.responseJSON[0].trends[3].url + '" target="_blank">' + obj.responseJSON[0].trends[3].name + '</a><br><span class="tweetVolume">' + ((obj.responseJSON[0].trends[3].tweet_volume != null) ? obj.responseJSON[0].trends[3].tweet_volume + " tweets" + '</span>' : '</span><br>');
            trend[9].innerHTML= '<a href="' + obj.responseJSON[0].trends[3].url + '" target="_blank">' + obj.responseJSON[0].trends[3].name + '</a><br><span class="tweetVolume">' + ((obj.responseJSON[0].trends[3].tweet_volume != null) ? obj.responseJSON[0].trends[3].tweet_volume + " tweets" + '</span>' : '</span><br>');
            trend[10].innerHTML= '<a href="' + obj.responseJSON[0].trends[3].url + '" target="_blank">' + obj.responseJSON[0].trends[3].name + '</a><br><span class="tweetVolume">' + ((obj.responseJSON[0].trends[3].tweet_volume != null) ? obj.responseJSON[0].trends[3].tweet_volume + " tweets" + '</span>' : '</span><br>');
            trend[11].innerHTML= '<a href="' + obj.responseJSON[0].trends[3].url + '" target="_blank">' + obj.responseJSON[0].trends[3].name + '</a><br><span class="tweetVolume">' + ((obj.responseJSON[0].trends[3].tweet_volume != null) ? obj.responseJSON[0].trends[3].tweet_volume + " tweets" + '</span>' : '</span><br>');
