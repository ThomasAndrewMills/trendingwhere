...
function initialize() {
    ...
    google.maps.event.addListener(marker1, 'click', function () {
        var obj = $.getJSON('/twitter-proxy.php?url=' + encodeURIComponent('trends/place.json?id=21125'), function (result) {
            ...
            trend[0].innerHTML= '<a href="' + obj.responseJSON[0].trends[0].url + '" target="_blank">' + '<b>' + obj.responseJSON[0].trends[0].name + '</b></a><br>' + ((obj.responseJSON[0].trends[0].tweet_volume != null) ? obj.responseJSON[0].trends[0].tweet_volume + " tweets" : '<br>');
            trend[1].innerHTML= '<a href="' + obj.responseJSON[0].trends[1].url + '" target="_blank">' + '<b>' + obj.responseJSON[0].trends[1].name + '</b></a><br>' + ((obj.responseJSON[0].trends[1].tweet_volume != null) ? obj.responseJSON[0].trends[1].tweet_volume + " tweets" : '<br>');
            trend[2].innerHTML= '<a href="' + obj.responseJSON[0].trends[2].url + '" target="_blank">' + '<b>' + obj.responseJSON[0].trends[2].name + '</b></a><br>' + ((obj.responseJSON[0].trends[2].tweet_volume != null) ? obj.responseJSON[0].trends[2].tweet_volume + " tweets" : '<br>');
            trend[3].innerHTML= '<a href="' + obj.responseJSON[0].trends[3].url + '" target="_blank">' + '<b>' + obj.responseJSON[0].trends[3].name + '</b></a><br>' + ((obj.responseJSON[0].trends[3].tweet_volume != null) ? obj.responseJSON[0].trends[3].tweet_volume + " tweets" : '<br>');
            trend[4].innerHTML= '<a href="' + obj.responseJSON[0].trends[4].url + '" target="_blank">' + '<b>' + obj.responseJSON[0].trends[4].name + '</b></a><br>' + ((obj.responseJSON[0].trends[4].tweet_volume != null) ? obj.responseJSON[0].trends[4].tweet_volume + " tweets" : '<br>');
            trend[5].innerHTML= '<a href="' + obj.responseJSON[0].trends[5].url + '" target="_blank">' + '<b>' + obj.responseJSON[0].trends[5].name + '</b></a><br>' + ((obj.responseJSON[0].trends[5].tweet_volume != null) ? obj.responseJSON[0].trends[5].tweet_volume + " tweets" : '<br>');
            trend[6].innerHTML= '<a href="' + obj.responseJSON[0].trends[6].url + '" target="_blank">' + '<b>' + obj.responseJSON[0].trends[6].name + '</b></a><br>' + ((obj.responseJSON[0].trends[6].tweet_volume != null) ? obj.responseJSON[0].trends[6].tweet_volume + " tweets" : '<br>');
