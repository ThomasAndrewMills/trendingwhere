...
function initialize() {
    ...
    google.maps.event.addListener(marker1, 'click', function () {
        var obj = $.getJSON('/twitter-proxy.php?url=' + encodeURIComponent('trends/place.json?id=21125'), function (result) {
            ...
            trend[1].innerHTML= '<a href="' + obj.responseJSON[0].trends[1].url + '" target="_blank">' + obj.responseJSON[0].trends[1].name + '</a><br>' + ((obj.responseJSON[0].trends[1].tweet_volume != null) ? obj.responseJSON[0].trends[1].tweet_volume + " tweets" : '<br>');
            trend[2].innerHTML= '<a href="' + obj.responseJSON[0].trends[2].url + '" target="_blank">' + obj.responseJSON[0].trends[2].name + '</a><br>' + ((obj.responseJSON[0].trends[2].tweet_volume != null) ? obj.responseJSON[0].trends[2].tweet_volume + " tweets" : '<br>');
            trend[3].innerHTML= '<a href="' + obj.responseJSON[0].trends[3].url + '" target="_blank">' + obj.responseJSON[0].trends[3].name + '</a><br>' + ((obj.responseJSON[0].trends[3].tweet_volume != null) ? obj.responseJSON[0].trends[3].tweet_volume + " tweets" : '<br>');
            trend[4].innerHTML= '<a href="' + obj.responseJSON[0].trends[4].url + '" target="_blank">' + obj.responseJSON[0].trends[4].name + '</a><br>' + ((obj.responseJSON[0].trends[4].tweet_volume != null) ? obj.responseJSON[0].trends[4].tweet_volume + " tweets" : '<br>');
            trend[5].innerHTML= '<a href="' + obj.responseJSON[0].trends[5].url + '" target="_blank">' + obj.responseJSON[0].trends[5].name + '</a><br>' + ((obj.responseJSON[0].trends[5].tweet_volume != null) ? obj.responseJSON[0].trends[5].tweet_volume + " tweets" : '<br>');
            trend[6].innerHTML= '<a href="' + obj.responseJSON[0].trends[6].url + '" target="_blank">' + obj.responseJSON[0].trends[6].name + '</a><br>' + ((obj.responseJSON[0].trends[6].tweet_volume != null) ? obj.responseJSON[0].trends[6].tweet_volume + " tweets" : '<br>');
            trend[7].innerHTML= '<a href="' + obj.responseJSON[0].trends[7].url + '" target="_blank">' + obj.responseJSON[0].trends[7].name + '</a><br>' + ((obj.responseJSON[0].trends[7].tweet_volume != null) ? obj.responseJSON[0].trends[7].tweet_volume + " tweets" : '<br>');
            trend[8].innerHTML= '<a href="' + obj.responseJSON[0].trends[8].url + '" target="_blank">' + obj.responseJSON[0].trends[8].name + '</a><br>' + ((obj.responseJSON[0].trends[8].tweet_volume != null) ? obj.responseJSON[0].trends[8].tweet_volume + " tweets" : '<br>');
            trend[9].innerHTML= '<a href="' + obj.responseJSON[0].trends[9].url + '" target="_blank">' + obj.responseJSON[0].trends[9].name + '</a><br>' + ((obj.responseJSON[0].trends[9].tweet_volume != null) ? obj.responseJSON[0].trends[9].tweet_volume + " tweets" : '<br>');
            trend[10].innerHTML= '<a href="' + obj.responseJSON[0].trends[10].url + '" target="_blank">' + obj.responseJSON[0].trends[10].name + '</a><br>' + ((obj.responseJSON[0].trends[10].tweet_volume != null) ? obj.responseJSON[0].trends[10].tweet_volume + " tweets" : '<br>');
            trend[11].innerHTML= '<a href="' + obj.responseJSON[0].trends[11].url + '" target="_blank">' + obj.responseJSON[0].trends[11].name + '</a><br>' + ((obj.responseJSON[0].trends[11].tweet_volume != null) ? obj.responseJSON[0].trends[11].tweet_volume + " tweets" : '<br>');
        });
