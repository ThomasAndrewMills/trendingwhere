...
function initialize() {
    ...
    google.maps.event.addListener(marker1, 'click', function () {
        var obj = $.getJSON('/twitter-proxy.php?url=' + encodeURIComponent('trends/place.json?id=21125'), function (result) {
            ...
            trend[3].innerHTML= '<a href="' + obj.responseJSON[0].trends[2].url + '" target="_blank">' + obj.responseJSON[0].trends[2].name + '</a><br><span class="tweetVolume">' + ((obj.responseJSON[0].trends[2].tweet_volume != null) ? obj.responseJSON[0].trends[2].tweet_volume + " tweets" + '</span>' : '</span><br>');
