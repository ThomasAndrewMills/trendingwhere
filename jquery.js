...
function initialize() {
    ...
    google.maps.event.addListener(marker1, 'click', function () {
        var obj = $.getJSON('/twitter-proxy.php?url=' + encodeURIComponent('trends/place.json?id=21125'), function (result) {
            ...
            trend[2].innerHTML= '<a href="' + obj.responseJSON[0].trends[2].url + '">' + '<b>' + obj.responseJSON[0].trends[2].name + '</b></a>' + ((obj.responseJSON[0].trends[2].tweet_volume != null) ? obj.responseJSON[0].trends[2].tweet_volume + " tweets" : "");
            trend[3].innerHTML= '<a href="' + obj.responseJSON[0].trends[3].url + '">' + '<b>' + obj.responseJSON[0].trends[3].name + '</b></a>' + ((obj.responseJSON[0].trends[3].tweet_volume != null) ? obj.responseJSON[0].trends[3].tweet_volume + " tweets" : "");
            trend[4].innerHTML= '<a href="' + obj.responseJSON[0].trends[4].url + '">' + '<b>' + obj.responseJSON[0].trends[4].name + '</b></a>' + ((obj.responseJSON[0].trends[4].tweet_volume != null) ? obj.responseJSON[0].trends[4].tweet_volume + " tweets" : "");
            trend[5].innerHTML= '<a href="' + obj.responseJSON[0].trends[5].url + '">' + '<b>' + obj.responseJSON[0].trends[5].name + '</b></a>' + ((obj.responseJSON[0].trends[5].tweet_volume != null) ? obj.responseJSON[0].trends[5].tweet_volume + " tweets" : "");
            trend[6].innerHTML= '<a href="' + obj.responseJSON[0].trends[6].url + '">' + '<b>' + obj.responseJSON[0].trends[6].name + '</b></a>' + ((obj.responseJSON[0].trends[6].tweet_volume != null) ? obj.responseJSON[0].trends[6].tweet_volume + " tweets" : "");
            trend[7].innerHTML= '<a href="' + obj.responseJSON[0].trends[7].url + '">' + '<b>' + obj.responseJSON[0].trends[7].name + '</b></a>' + ((obj.responseJSON[0].trends[7].tweet_volume != null) ? obj.responseJSON[0].trends[7].tweet_volume + " tweets" : "");
            trend[8].innerHTML= '<a href="' + obj.responseJSON[0].trends[8].url + '">' + '<b>' + obj.responseJSON[0].trends[8].name + '</b></a>' + ((obj.responseJSON[0].trends[8].tweet_volume != null) ? obj.responseJSON[0].trends[8].tweet_volume + " tweets" : "");
            trend[9].innerHTML= '<a href="' + obj.responseJSON[0].trends[9].url + '">' + '<b>' + obj.responseJSON[0].trends[9].name + '</b></a>' + ((obj.responseJSON[0].trends[9].tweet_volume != null) ? obj.responseJSON[0].trends[9].tweet_volume + " tweets" : "");
            trend[10].innerHTML= '<a href="' + obj.responseJSON[0].trends[10].url + '">' + '<b>' + obj.responseJSON[0].trends[10].name + '</b></a>' + ((obj.responseJSON[0].trends[10].tweet_volume != null) ? obj.responseJSON[0].trends[10].tweet_volume + " tweets" : "");
            trend[11].innerHTML= '<a href="' + obj.responseJSON[0].trends[11].url + '">' + '<b>' + obj.responseJSON[0].trends[11].name + '</b></a>' + ((obj.responseJSON[0].trends[11].tweet_volume != null) ? obj.responseJSON[0].trends[11].tweet_volume + " tweets" : "");
        });
